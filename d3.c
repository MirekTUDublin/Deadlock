#include <stdio.h>
#include <pthread.h>
pthread_mutex_t fork1, fork2, fork3, fork4;
...
void *philosopher3(void *param) {
    ...
    printf("\t\t\t\tPhilosopher 3 put down fork 4\n");
...
void *philosopher4(void *param) {
    while(1){
    printf("\t\t\t\t\t\tPhilosopher 4 wants to pick up fork 4\n");
    pthread_mutex_lock(&fork4);
    printf("\t\t\t\t\t\tPhilosopher 4 picked up fork 4\n");
    
    printf("\t\t\t\t\t\tPhilosopher 4 wants to pick up fork 1\n");
    pthread_mutex_lock(&fork1);
    printf("\t\t\t\t\t\tPhilosopher 4 picked up fork 1\n");
...
int main() {
    ...
    pthread_create(&t4, NULL, philosopher4, NULL);
